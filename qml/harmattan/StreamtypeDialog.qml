...
HarmattanCommonDialog {
	...
	content: Item{
		height: visualParent ? visualParent.height * 0.87 - root.platformStyle.titleBarHeight - root.platformStyle.contentSpacing - 50 : root.parent ? root.parent.height * 0.87 - root.platformStyle.titleBarHeight - root.platformStyle.contentSpacing - 50 : 350;
		width: root.width
		StreamtypeItem{
			id: streamtype_tab;
			anchors.fill: parent;
